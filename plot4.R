...
##plot4.1
with(electricityDataSmall, plot(DateTime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))

##plot4.2
with(electricityDataSmall, plot(DateTime, Voltage, type="l", xlab="datetime", ylab="Voltage"))
...
##plot4.4
with(electricityDataSmall, plot(DateTime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
